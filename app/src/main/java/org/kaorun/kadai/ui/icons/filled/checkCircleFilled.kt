...
val check_circle_filled: ImageVector
    get() {
        if (_check_circle_filled != null) {
            return _check_circle_filled!!
        }
        _check_circle_filled =
            Builder(
                name = "check_circle",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var _check_circle_filled: ImageVector? = null
